...
public class ChatClient extends UnicastRemoteObject implements InterfaceClient{
    ...
    public void openChat() throws RemoteException {
      ...
      public void logout() throws RemoteException {
        server.logoutClient(name); // Gửi yêu cầu đăng xuất đến server
        JOptionPane.showMessageDialog(new JFrame(), "You have logged out.", "Logout", JOptionPane.INFORMATION_MESSAGE);
        System.exit(0); // Thoát ứng dụng sau khi đăng xuất
    }
}